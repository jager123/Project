package com.jager.crowd.constant;

public class CrowdConstant {

    public static final String MESSAGE_LOGIN_FAILED = "抱歉，密码错误。请重新输入！";
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USE = "抱歉，这个账号已经被使用！";
    public static final String MESSAGE_STRING_INVALIDATE = "输入的字符串无效，请不要输入空字符串！";
    public static final String MESSAGE_ACCESS_FORBIDDEN = "请登录以后再访问！";
    public static final String MESSAGE_SYSTEM_LOGIN_NOT_UNIQUE = "系统错误：登录账号不唯一";
